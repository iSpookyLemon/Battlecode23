...
public strictfp class RobotPlayer {
    ...
    public static void pathfind(MapLocation end, int visionRadius) throws GameActionException {
        ...
        queue.add(new Pair(rc.getLocation(), rc.getLocation().distanceSquaredTo(end)));
        previous.put(rc.getLocation(), rc.getLocation());
        ...
        if (previous.get(current) != null) {
            while (previous.get(current) != rc.getLocation()) {
